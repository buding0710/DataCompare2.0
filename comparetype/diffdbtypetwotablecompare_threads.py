...
class DiffDbTypeTwoTableCompare():
    def __init__(self,conf_user,conf_db,conf_sql):
        ...
        self.comp = CompareDatabaseData(self.source_conn,self.source_db,self.source_table,self.target_conn,self.target_db,self.target_table)
    ...
    def fullDataCompare(self):  # 全量对比
        ...
        compare_full_table_result =self.comp.fullTableMD5compare(source_db_get_data_sql, target_db_get_data_sql,
    ...
    def incrementalDataCompare(self):  # 增量对比
        ...
        compare_full_table_result = self.comp.fullTableMD5compare(incremental_data_sql1,
